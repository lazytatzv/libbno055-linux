...
private:
    void configure_parameters() {
        ...
        integral_limit_rad_s_ = this->declare_parameter("integral_limit", 0.5);
        heading_deadband_rad_ = this->declare_parameter("heading_deadband_rad", 0.02);
        rotation_input_deadband_rad_s_ = this->declare_parameter("rotation_input_deadband_rad_s", 0.02);
        max_correction_rad_s_ = this->declare_parameter("max_correction_rad_s", 1.5);
        control_period_ms_ = this->declare_parameter("control_period_ms", 10);
        command_timeout_ms_ = this->declare_parameter("command_timeout_ms", 500);
        imu_timeout_ms_ = this->declare_parameter("imu_timeout_ms", 250);
        command_qos_depth_ = this->declare_parameter("command_qos_depth", 10);
        raw_cmd_vel_topic_ = this->declare_parameter<std::string>("raw_cmd_vel_topic", "/drive/cmd_vel");
