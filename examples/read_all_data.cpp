...
void printBarIndicator(const std::string& label, double val_deg) {
    ...
    std::cout << label << " [" << bar << "] " 
              << std::fixed << std::setprecision(2) << std::setw(7) << val_deg << " deg" << std::endl;
}
...
int main(int argc, char* argv[]) {
    ...
    while (true) {
        try {
            ...
            std::cout << "Yaw   (Z)  " << std::fixed << std::setprecision(2) << std::setw(7) << euler_deg.z << " deg" << std::endl;
            std::cout << "-------------------------------------------------------------" << std::endl;
            
            std::cout << "Accelerometer (m/s^2):       X=" << std::setw(7) << accel.x << " Y=" << std::setw(7) << accel.y << " Z=" << std::setw(7) << accel.z << std::endl;
            std::cout << "Magnetometer (uT):           X=" << std::setw(7) << mag.x << " Y=" << std::setw(7) << mag.y << " Z=" << std::setw(7) << mag.z << std::endl;
            std::cout << "Gyroscope (rad/s):           X=" << std::setw(7) << gyro.x << " Y=" << std::setw(7) << gyro.y << " Z=" << std::setw(7) << gyro.z << std::endl;
            std::cout << "Euler Angles (rad):          Roll=" << std::setw(7) << euler.x << " Pitch=" << std::setw(7) << euler.y << " Yaw=" << std::setw(7) << euler.z << std::endl;
            std::cout << "Linear Acceleration (m/s^2):  X=" << std::setw(7) << linear.x << " Y=" << std::setw(7) << linear.y << " Z=" << std::setw(7) << linear.z << std::endl;
            std::cout << "Gravity Vector (m/s^2):       X=" << std::setw(7) << gravity.x << " Y=" << std::setw(7) << gravity.y << " Z=" << std::setw(7) << gravity.z << std::endl;
            std::cout << "Quaternion:                  W=" << std::setw(7) << quat.w << " X=" << std::setw(7) << quat.x << " Y=" << std::setw(7) << quat.y << " Z=" << std::setw(7) << quat.z << std::endl;
